...
To contribute to face-detection-yolov8 project on [GitHub](https://github.com/luismayta/face-detection-yolov8), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/face-detection-yolov8/pulls).
...
To follow the instructions in this guide and start contributing to face-detection-yolov8 project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/face-detection-yolov8.git
```

Now your **upstream** points to **luismayta/face-detection-yolov8**.
...
git fetch upstream # assuming upstream is luismayta/face-detection-yolov8
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/face-detection-yolov8/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
